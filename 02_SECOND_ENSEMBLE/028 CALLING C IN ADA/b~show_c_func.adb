pragma Ada_95;
pragma Warnings (Off);
pragma Source_File_Name (ada_main, Spec_File_Name => "b~show_c_func.ads");
pragma Source_File_Name (ada_main, Body_File_Name => "b~show_c_func.adb");
...
package body ada_main is
   ...
   pragma Import (Ada, Ada_Main_Program, "_ada_show_c_func");
...
--  BEGIN Object file/option list
   --   .\show_c_func.o
   --   -L.\
   --   -LC:/TOOLS/MinGW/lib/gcc/mingw32/6.3.0/adalib/
   --   -static
   --   -lgnat
   --   -Wl,--stack=0x2000000
